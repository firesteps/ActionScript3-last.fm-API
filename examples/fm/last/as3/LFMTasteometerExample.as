package{
	...
	import fm.last.as3.LFMTasteometer;
	
	public class LFMTasteometerExample extends Sprite{
		private var _session:ILFMSession;
		public function LFMTasteometerExample(){
			super();
			_session = new LFMSession('b25b959554ed76058ac220b7b2e0a026');
			
			addListeners(new LFMTasteometer(_session).compare('user','user','joanofarctan','firesteps'));
		}
