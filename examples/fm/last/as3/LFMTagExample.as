package{
	...
	public class LFMTagExample extends Sprite{
		private var _session:ILFMSession;
		public function LFMTagExample(){
			super();
			_session = new LFMSession('b25b959554ed76058ac220b7b2e0a026');
			
			var tag:LFMTag = new LFMTag(_session);
			
			addListeners(tag.getSimilar('8bit'));
			addListeners(tag.getTopAlbums('8bit'));
			addListeners(tag.getTopTags());
			addListeners(tag.getWeeklyArtistChart('8bit'));
			addListeners(tag.search('8bit'));
		}
