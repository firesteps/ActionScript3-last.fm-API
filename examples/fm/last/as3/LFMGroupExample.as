package{
	...
	import fm.last.as3.LFMGroup;
	import fm.last.as3.LFMSession;
	
	public class LFMGroupExample extends Sprite	{
		private var _session:ILFMSession;
		
		public function LFMGroupExample(){
			super();
			_session = new LFMSession('b25b959554ed76058ac220b7b2e0a026');
			var group:LFMGroup = new LFMGroup(_session);
			
			addListeners(group.getHype('radiohead'));
			addListeners(group.getMembers('radiohead'));
			addListeners(group.getWeeklyAlbumChart('radiohead'));
		}
